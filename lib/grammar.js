...
import { freeze, freezeClass, isPlainObject } from '@bablr/agast-helpers/object';
...
export const startSpan = (name, guard, props = freeze({})) => {
  return __buildCall('startSpan', name, guard, false, o(props));
};

export const startSubspan = (name, guard, props = freeze({})) => {
