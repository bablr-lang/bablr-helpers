...
import { interpolateFragment, groupTags, streamFromString } from '@bablr/agast-helpers/stream';
import {
  continue_,
  getStreamIterator,
  StreamIterable,
...
export function* writeReferenceFlags(flags = parseReferenceFlags()) {
...
export function* writeNodeFlags(flags = parseNodeFlags()) {
