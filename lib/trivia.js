...
export const triviaEnhancer = (
  ...
  let resultGrammar = mapProductions((production) => {
    return function* (props) {
      ...
      let { type, getState, flags, isCover, isCoverBoundary: thisIsCoverBoundary } = props;
          ...
          switch (verb) {
            ...
            case 'guard': {
              ...
              if (
                ...
                if (
                  triviaIsAllowed(s) &&
                  get(['valueMatcher', 'nodeMatcher'], matcher.value).value.open.type
  ...
  return class extends resultGrammar {
    ...
    *[Trivia_]({ props: { matchTrailing, matcher, props, options } }) {
      ...
      let returnValue = yield eat(
        ...
        matcher.value.value.open.type === Symbol.for('PropertyMatcher')
          ? buildEmbeddedMatcher(buildPropertyMatcher(null, get(['valueMatcher'], matcher.value)))
          : matcher,
        props,
