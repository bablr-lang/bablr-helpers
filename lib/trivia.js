          ...
          switch (verb) {
            ...
            case 'guard': {
              ...
              let matcherFlags =
                ...
                reifyExpression(get(['open', 'flags'], getNodeMatcher(matcher.value)));
              ...
              if (
                ...
                if (
                  triviaIsAllowed(s) &&
                  getNodeMatcher(matcher.value).type?.description === 'TreeNodeMatcher'
                ) {
      ...
      let returnValue = yield eat(
        ...
        matcher.value.type === Symbol.for('PropertyMatcher')
          ? buildEmbeddedMatcher(
              buildPropertyMatcher(
                null,
                get('bindingMatchers', matcher.value),
                getNodeMatcher(matcher.value),
              ),
            )
          : matcher,
