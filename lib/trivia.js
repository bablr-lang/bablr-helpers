import { printSource, streamFromTree } from '@bablr/agast-helpers/tree';
            ...
            switch (verb) {
              ...
              case 'guard': {
                ...
                if (
                  ...
                  (matcher.type !== Callable || matcher.value.reference?.type !== '#')
                ) {
                ...
                if (step.done) {
                  ...
                  if (
                    s.source.atGap &&
                    (matcher.value.reference?.attributes.hasGap ||
                    ...
                    continue;
                  } else if (s.held && !s.shifted && matcher.value.nodeMatcher.value.flags.token) {
                    let empty = isEmpty(streamFromTree(s.held, { getGapNode }));
